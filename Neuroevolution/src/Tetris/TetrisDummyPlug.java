...
class TetrisDummyPlug extends JComponentWithEvents 
{
	/**
	 * 
	 */
	...
	NeuralNetwork dummyPlug;
	double[][] input;
	int inputCount;
	double placedPieceInputWeight;
	double fallingPieceInputWeight;
	...
	// Constructor
	public TetrisDummyPlug(int setRows, int setCols) 
	{
		rows = setRows;
		cols = setCols;
	...
	public void resetGame() 
	{
		...
		loop("TetrisTheme.wav"); // Start the music
		gameScore = 0; // Clear the score
		
		//Setting up Neural Network
		dummyPlug = new NeuralNetwork(inputCount, 6, 6, 25);
		dummyPlug.printStatusToConsole();
	}
	...
	public void activateNN()
	{
		...
		Vector<Double> output = dummyPlug.activate(nnInput);
